...
import com.reactnative.baiducloud.videoplayer.bar.AdvancedMediaController;
import com.reactnative.baiducloud.videoplayer.info.DownloadObserverManager;
import com.reactnative.baiducloud.videoplayer.info.SampleObserver;
        ...
        mediaController.setDownloadListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                VideoDownloadManager downloadManagerInstance = VideoDownloadManager
                        .getInstance(AdvancedPlayActivity.this, "User");
