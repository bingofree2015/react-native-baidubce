...
/**
 ...
 - BDCloudMediaPlayerOptionCategoryFormat:          解封装选项。
 - BDCloudMediaPlayerOptionCategoryCodec:           解码器选项。
 - BDCloudMediaPlayerOptionCategorySws:             缩放选项。
 - BDCloudMediaPlayerOptionCategoryPlayer:          播放内核选项。
 - BDCloudMediaPlayerOptionCategorySwr:             重采样选项。
 */
typedef NS_ENUM(NSInteger, BDCloudMediaPlayerOptionCategory) {
    BDCloudMediaPlayerOptionCategoryFormat = 1,
    BDCloudMediaPlayerOptionCategoryCodec  = 2,
    BDCloudMediaPlayerOptionCategorySws    = 3,
    BDCloudMediaPlayerOptionCategoryPlayer = 4,
    BDCloudMediaPlayerOptionCategorySwr    = 5,
};
